...
<html lang="en">
    ...
    <body onload="md.notifyCard('Login Error','<?php echo  $_SESSION['loginError']; ?>','danger')" class="off-canvas-sidebar">
        <?php }else{ ?>
...
<!--                 style="background-image: url('--><?php //echo site_url('public/theme/'); ?><!--assets/img/login.jpg'); background-size: cover; background-position: top center;">-->
                ...
                <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
                        ...
                        <form class="form" method="post" action="<?= site_url('loginUser'); ?>">



                            <div class="card card-login card-hidden">
                                <div class="card-header card-header-rose text-center">
                                    <h4 class="card-title">Car Hakeem Admin Login</h4></div>
                                <div class="card-body ">
                                    <p class="card-description text-center"></p> <span class="bmd-form-group">
